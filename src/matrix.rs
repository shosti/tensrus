...
//         let t: GenericTensor<T, { matrix_shape(M, N) }> = arr.into_iter().collect();
//         Self(t)
//     }
// }
...
//         let t: GenericTensor<T, { matrix_shape(M, N) }> = arrs.into_iter().flatten().collect();
//         Self(t)
//     }
// }
...
// where
//     [(); matrix_shape(M, N).rank()]:,
//     [(); matrix_shape(N, P).rank()]:,
//     [(); matrix_shape(M, P).rank()]:,
// {
